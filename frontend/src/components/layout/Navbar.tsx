      ...
      <div className="container flex h-14 items-center justify-between px-4">
        <div className="flex items-center gap-6">
          ...
          <nav className="flex items-center gap-4 text-sm font-medium">
            <Link to="/" className="text-muted-foreground hover:text-foreground">Modul Saya</Link>
            <Link to="/history" className="text-muted-foreground hover:text-foreground">Riwayat</Link>
            {isAdmin() && (
